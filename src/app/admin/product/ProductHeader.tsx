const ProductHeader = () => {
    ...
    return (
        <div className="flex items-center border-[1.2px] border-slate-200 bg-slate-50 rounded-sm p-2 transition text-center text-sm font-semibold">
            ...
            <div className="flex-1 ml-4">promotional price</div>
            <div className="flex-1 ml-4">view</div>
            <div className="flex-1 ml-4">is selling</div>
            <div className="flex-1 ml-4">rating</div>
            <div className="flex-1 ml-4">created at</div>
            <div className="flex-1 ml-4">updated at</div>
            <div className="flex-1 ml-4">created by</div>
