...
import UserLevelRecord from "./UserLevelRecord";
import UserLevelHeader from "./UserLevelHeader";
import Button from "@/app/components/Button";
import { SiAddthis } from "react-icons/si";
import { FaSearch } from "react-icons/fa";
import callApiRoute from "@/pages/api/admin/user/level/findAll";
...
const ManageUserLevels = () => {
  ...
  const handleAddUserLevelClick = () => {
    router.push('/admin/user-level/add');
  };
    ...
    <div className="p-8">
      <Container>
        <div>
          ...
          custom="bg-green-300" 
          label="Add UserLevel" 
          onClick={handleAddUserLevelClick} icon={SiAddthis} />
        ...
        <div>
          ...
          <UserLevelHeader/>
          {deliveries.map((userLevel: any, index: number) => (
            <UserLevelRecord
