...
export const API_BACKEND_URL = '192.168.1.121';
...
export const JOSE_ISSUER = 'fashion_ecommerce'
export const JOSE_AUDIENCE = 'fashion_ecommerce'

export const JWT_EMAIL_EXPIRATION = 60
export const JWT_FORFOT_PASSWORD_EMAIL_EXPIRATION = 120
